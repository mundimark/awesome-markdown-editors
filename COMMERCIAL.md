...
(web: [`comment.io`](https://comment.io),
 github: [`comment-io/comment.io`](https://github.com/comment-io/comment.io) issue only, no source) - Agent-native document editor. @mention an agent — it reads the doc and responds via webhook, autonomously. Humans and agents reading, commenting, and editing markdown together, with per-edit authorship tracking.
